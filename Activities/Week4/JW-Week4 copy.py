...
# each time you create a tagger you can evaluate on the test set
# creates a predicted test set and then reports accuracy
...
# one long list of tokens
taggedtext_flat = [pair for sent in taggedtext for pair in sent]
print(taggedtext_flat)

# this is how you flatten the list of the Stamford tagged text
